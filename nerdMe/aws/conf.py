...
AWS_GROUP_NAME = "CFE_nerdMe_Group"
AWS_USERNAME = "cfe-nerdMe-user"

AWS_FILE_EXPIRE = 200
AWS_PRELOAD_METADATA = True
AWS_QUERYSTRING_AUTH = False

DEFAULT_FILE_STORAGE = 'nerdMe.aws.utils.MediaRootS3BotoStorage'
STATICFILES_STORAGE = 'nerdMe.aws.utils.StaticRootS3BotoStorage'
AWS_STORAGE_BUCKET_NAME = 'cfe-nerdMe'

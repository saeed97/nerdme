...
from groups.models import Task, Comment
...
def test_tracker_task_creation(groups_setup, django_user_model):
    ...
    msg["References"] = "<thread-{}@django-groups> <unknown@example.com>".format(task.pk)

...
# from nerdMe.utils import random_string_generator, unique_key_generator
...
#     REQUIRED_FIELDS = [] #['full_name'] #python manage.py createinfosuperuser
#     groups = forms.ModelChoiceField(queryset=Group.objects.all(),required=True)

#     # from django.contrib.auth.models import Group
#     # my_group = Group.objects.get_or_create(name='Departments') 
#     # if(my_group):
#     #     email.groups.add(my_group)
#     objects = UserManager()
...
#             if self.key:
#                 base_url = getattr(settings, 'BASE_URL', 'https://www.pythonnerdMe.com')
